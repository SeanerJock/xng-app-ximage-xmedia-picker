package cn.xiaoniangao.ximagemedia.adapter;
...
import cn.xiaoniangao.ximagemedia.PickerConfig;
import cn.xiaoniangao.ximagemedia.R;
...
public class MediaGridAdapter extends RecyclerView.Adapter<MediaGridAdapter.MyViewHolder> {
    ...
    public MediaGridAdapter(ArrayList<Media> list, Context context, ArrayList<Media> select, int max, long maxSize, String fullToast) {
        if (select != null) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                if (selectMedias.size() >= maxSelect && isSelect < 0) {
                    if (TextUtils.isEmpty(fullToast)) {
                        ...
                        Toast.makeText(context, fullToast, Toast.LENGTH_SHORT).show();
                    }
                } else {
        ...
        holder.media_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mOnItemClickListener.onPreviewClick(media);
            }
        });
    }
    ...
    public interface OnRecyclerViewItemClickListener {
        ...
        void onPreviewClick(Media data);
    }
}
